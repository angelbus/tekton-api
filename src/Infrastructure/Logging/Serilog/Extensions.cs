...
namespace Tekton.API.Infrastructure.Logging.Serilog;
...
public static class Extensions
{
    public static void RegisterSerilog(this WebApplicationBuilder builder)
    {
        ...
        _ = builder.Host.UseSerilog((_, sp, serilogConfig) =>
        {
            ...
            {
                Console.WriteLine("Environment variable for ElasticSearchUrl: " + elasticSearchUrl);
            }
            else
            {
                elasticSearchUrl = loggerSettings.ElasticSearchUrl;
                Console.WriteLine("Environment variable for ElasticSearchUrl does not exist");
            }
