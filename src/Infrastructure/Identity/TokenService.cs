...
using Tekton.API.Application.Identity.Tokens;
using Tekton.API.Infrastructure.Auth;
using Tekton.API.Infrastructure.Auth.Jwt;
...
*/
    ...
    private IEnumerable<Claim> GetClaims(ApplicationUser user, string ipAddress) =>
        new List<Claim>
        {
            ...
            new(TektonClaims.Fullname, $"{user.FirstName} {user.LastName}"),
            new(ClaimTypes.Name, user.FirstName ?? string.Empty),
            new(ClaimTypes.Surname, user.LastName ?? string.Empty),
            new(TektonClaims.IpAddress, ipAddress),
            new(TektonClaims.Tenant, _currentTenant!.Id),
            new(TektonClaims.ImageUrl, user.ImageUrl ?? string.Empty),
