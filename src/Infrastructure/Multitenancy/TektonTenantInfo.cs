...
public class TektonTenantInfo : ITenantInfo
{
    public TektonTenantInfo()
    {
    }

    public TektonTenantInfo(string id, string name, string? connectionString, string adminEmail, string? issuer = null)
    {
        Id = id;
        Identifier = id;
        Name = name;
